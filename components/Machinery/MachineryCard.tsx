  ...
  return (
    <div className="group bg-white dark:bg-[#382d22] rounded-2xl shadow-sm border border-[#e8e4e0] dark:border-[#3a2f24] overflow-hidden flex flex-col hover:shadow-xl transition-all duration-300">
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <button
          onClick={onView}
          className="w-full py-3 px-4 bg-background-light dark:bg-background-dark border border-[#e8e4e0] dark:border-[#3a2f24] rounded-xl text-sm font-bold hover:bg-primary hover:text-white hover:border-primary transition-all flex items-center justify-center gap-2"
        >
