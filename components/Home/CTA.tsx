        ...
        <div className="relative z-10 flex flex-col items-center gap-8 text-center">
          <div className="flex flex-col gap-4 max-w-[720px]">
            <h2 className="text-white text-4xl lg:text-5xl font-black leading-tight tracking-tight">
              Ready to elevate your coffee production?
            </h2>
            <p className="text-[#cbbab0] text-lg font-normal leading-relaxed">
              Join hundreds of growers and roasters who have scaled their
              business with Jaber machinery. Contact our experts today for a
              customized machinery consultation.
            </p>
          </div>
